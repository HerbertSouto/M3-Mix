    ...
    <div className="dark" style={{ minHeight: '100vh', background: BG, color: '#eeeef5', overflowX: 'hidden' }}>
      ...
      <nav className="m3-nav" style={{
        ...
        <div style={{ display: 'flex', gap: 6, alignItems: 'center' }}>
          <a href="https://github.com/HerbertSouto" target="_blank" rel="noopener noreferrer" style={{
            display: 'flex', alignItems: 'center', gap: 6,
            color: 'rgba(238,238,245,.4)', textDecoration: 'none',
            fontSize: 12, fontFamily: MONO,
            padding: '6px 12px', borderRadius: 6,
            border: '1px solid rgba(238,238,245,.08)',
            transition: 'all .15s',
          }}
          onMouseEnter={e => { (e.currentTarget as HTMLElement).style.color = '#eeeef5'; (e.currentTarget as HTMLElement).style.borderColor = 'rgba(238,238,245,.2)' }}
          onMouseLeave={e => { (e.currentTarget as HTMLElement).style.color = 'rgba(238,238,245,.4)'; (e.currentTarget as HTMLElement).style.borderColor = 'rgba(238,238,245,.08)' }}
          >
          ...
          <a href="https://www.linkedin.com/in/herbertsouto/" target="_blank" rel="noopener noreferrer" style={{
            display: 'flex', alignItems: 'center', gap: 6,
            color: 'rgba(238,238,245,.4)', textDecoration: 'none',
            fontSize: 12, fontFamily: MONO,
            padding: '6px 12px', borderRadius: 6,
        ...
        <div className="m3-hero-grid" style={{
          ...
          <div>
            ...
            <div className="m3-a5" style={{
              ...
              {[
                { val: '5–8 min',   label: 'tempo de análise' },
      ...
      <footer style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 16 }}>
          <span style={{ fontFamily: SYNE, fontWeight: 800, fontSize: 14, color: ACCENT, opacity: .6 }}>M3-Mix</span>
          <span style={{ fontSize: 11, color: 'rgba(238,238,245,.2)', fontFamily: MONO }}>
            Desenvolvido por Herbert Souto
          </span>
        </div>
        <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
          <a href="https://github.com/HerbertSouto" target="_blank" rel="noopener noreferrer"
            style={{ color: 'rgba(238,238,245,.25)', textDecoration: 'none', transition: 'color .15s' }}
            onMouseEnter={e => (e.currentTarget as HTMLElement).style.color = 'rgba(238,238,245,.7)'}
            onMouseLeave={e => (e.currentTarget as HTMLElement).style.color = 'rgba(238,238,245,.25)'}
          >
            <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
              <path d="M12 2C6.477 2 2 6.477 2 12c0 4.418 2.865 8.166 6.839 9.489.5.092.682-.217.682-.482 0-.237-.009-.866-.013-1.7-2.782.603-3.369-1.342-3.369-1.342-.454-1.155-1.11-1.463-1.11-1.463-.908-.62.069-.608.069-.608 1.003.07 1.531 1.03 1.531 1.03.892 1.529 2.341 1.087 2.91.832.092-.647.35-1.088.636-1.338-2.22-.253-4.555-1.11-4.555-4.943 0-1.091.39-1.984 1.029-2.683-.103-.253-.446-1.27.098-2.647 0 0 .84-.269 2.75 1.025A9.578 9.578 0 0 1 12 6.836a9.59 9.59 0 0 1 2.504.337c1.909-1.294 2.747-1.025 2.747-1.025.546 1.377.202 2.394.1 2.647.64.699 1.028 1.592 1.028 2.683 0 3.842-2.339 4.687-4.566 4.935.359.309.678.919.678 1.852 0 1.336-.012 2.415-.012 2.741 0 .267.18.578.688.48C19.138 20.163 22 16.418 22 12c0-5.523-4.477-10-10-10z"/>
            </svg>
          </a>
          <a href="https://www.linkedin.com/in/herbertsouto/" target="_blank" rel="noopener noreferrer"
            style={{ color: 'rgba(238,238,245,.25)', textDecoration: 'none', transition: 'color .15s' }}
            onMouseEnter={e => (e.currentTarget as HTMLElement).style.color = 'rgba(238,238,245,.7)'}
            onMouseLeave={e => (e.currentTarget as HTMLElement).style.color = 'rgba(238,238,245,.25)'}
          >
          ...
          <span style={{ fontSize: 11, color: 'rgba(238,238,245,.12)', fontFamily: MONO }}>
            Bayesiano · IA · Open Source
          </span>
        </div>
      </footer>
